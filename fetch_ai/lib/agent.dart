...
class MyAgent extends AgentConfiguration {
  ...
  Metadata get metadata =>
      Metadata(name: 'Fetch AI', avatarProfile: 'assets/logo.png', tags: []);

  @override
  String get registerSystemPrompt =>
      '''You are a Fetch AI agents builder assistant. Answer user queries based on documents attached., Be truthful and don't hesitate to admit if you don't know something and quote links if helps.''';
