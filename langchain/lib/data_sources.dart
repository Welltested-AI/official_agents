...
class DocsDataSource extends DataSource {
  ...
  List<WebDataObject> get webObjects => [
        ...
        WebDataObject.fromSiteMap('https://js.langchain.com/v0.2/sitemap.xml'),
        WebDataObject.fromGithub(
            'https://github.com/langchain-ai/langchainjs', accessToken,
            codeFilter: CodeFilter(pathRegex: r'^cookbook\/.*')),
        WebDataObject.fromGithub(
            'https://github.com/langchain-ai/langchain', accessToken,
            codeFilter: CodeFilter(pathRegex: r'^cookbook\/.*'))
      ];
}
