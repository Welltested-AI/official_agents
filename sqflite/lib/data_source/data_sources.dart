...
import 'package:sqflite/data_source/sitemap_url_fetcher_helper.dart';
...
class DocsDataSource extends DataSource {
  ...
  List<WebDataObject> get webObjects => [
        for (final docUrl
            in sitemapUrlFetcher('assets/documents/sqflite_sitemap.xml'))
...
class ExampleDataSource extends DataSource {
  ...
  List<FileDataObject> get fileObjects => [
        FileDataObject.fromDirectory(Directory('assets/examples/official/lib'),
            ...
            regex: RegExp(r'(\.dart$)'),
            relativeTo:
                '/Users/yogesh/Development/org.welltested/default_agents/sqflite/assets/examples')
      ];
