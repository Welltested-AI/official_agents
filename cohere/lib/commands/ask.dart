...
class AskCommand extends Command {
  ...
  @override
  String get intent => 'Ask me anything about Cohere';
  ...
  List<Step> get steps {
    ...
    return [
      ...
      PromptQueryStep(
        prompt:
            '''You are a Cohere LLM integration agent. Here is the $userQuery, here is the $codeAttachment and some relevant documents for your reference: $matchingDocuments. 
