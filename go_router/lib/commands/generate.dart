...
Please provide the list of relevant references in the specified Markdown format.''',
      ...
      PromptQueryStep(
          prompt:
              '''You are tasked with generating Flutter code to implement navigation in a flutter app using the go_router package. Your goal is to create code snippets that demonstrate how to define routes, navigate between screens, and handle route parameters using go_router based on the instructions <Instructions> and relevant code references/examples <Code References> shared.
